...
// tl.from("#frame1-text-back", time+between, {autoAlpha:0, x:"-50"},"-="+between);
  ...
  tl.from("#frame1-people", 0.4, {scale:0.2, autoAlpha:0, ease:Back.easeOut})
  	.from("#frame1-people", 1.4, {top:0, ease:Power2.easeOut})
 	.to("#frame1-people", 0.2, {autoAlpha:0, top:"-=300px"}, "introOut")

 	.from("#bluebg", 1.4, {top:0, ease:Power2.easeOut})
 	.to("#bluebg", 0.2, {autoAlpha:0, top:"-=300px"}, "introOut")
